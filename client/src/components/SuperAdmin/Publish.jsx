  ...
  return (
    <main className="bg-gray-100">
      ...
      <div className="container py-4 pl-6 text-black">
        ...
        {/* <h3 className="text-1xl font-semibold mb-4">Publish Type</h3> */}

        <Form className='MISDistrict-form' onSubmit={handleSubmit}>
          <Form.Group>
            ...
            <div>
              ...
              <Form.Check
                ...
                name="publishtype"
                onChange={handleChange}
                checked={formData.publishtype==='supplementart1'}
